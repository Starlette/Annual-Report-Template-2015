$(document).ready(function() {
	...
	var $responsive = function(){
		if ($(window).width() < 800) {
			...
			$totalResponsive = $(".mobileHeader").size();
			if($totalResponsive>=2){
				$(".mobileHeader").remove();
				$("nav").append("<div class='mobileHeader'><ol><li><a class='closeMenu' href='#'>&#xe02c;</a></li>"+$headerLists+"</ol><p>"+$headerTxt+"</p></div>");
			}
			...
			$("nav li").each(function(index, element) {
                var $total = $(".closeDropdown",this).size();
				if($total>=2){
					$(".closeDropdown",this).remove();
					$(".page",this).prepend('<a class="closeDropdown"><em>CLOSE DROPDOWN</em> <span>&#xe02d;</span></a>');
				}
            });
